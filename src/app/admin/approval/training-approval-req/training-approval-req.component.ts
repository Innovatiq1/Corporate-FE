...
@Component({
  selector: 'app-training-approval-req',
  templateUrl: './training-approval-req.component.html',
  styleUrls: ['./training-approval-req.component.scss']
})
export class TrainingApprovalReqComponent extends UnsubscribeOnDestroyAdapter
implements OnInit{
  breadscrums = [
    {
      title: 'TMS',
