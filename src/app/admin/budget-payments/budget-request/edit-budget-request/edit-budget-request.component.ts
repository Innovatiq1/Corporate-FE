...
@Component({
  ...
  templateUrl: './edit-budget-request.component.html',
  styleUrls: ['./edit-budget-request.component.scss'],
})
export class EditBudgetRequestComponent {
  action: string;
  dialogTitle: string;
  ...
  constructor(
    public dialogRef: MatDialogRef<EditBudgetRequestComponent>,
