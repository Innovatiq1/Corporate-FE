...
import { EditRequestComponent } from '../../../admin/approval/training-approval-req/edit-request/edit-request.component';


@Component({
  selector: 'app-training-approval-tab',
  templateUrl: './training-approval-tab.component.html',
  styleUrls: ['./training-approval-tab.component.scss']
})



  export class TrainingApprovalTabComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit{
    breadscrums = [
      {
        title: 'ETMS',
