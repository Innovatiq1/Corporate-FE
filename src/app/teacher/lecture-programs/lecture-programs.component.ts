...
@Component({
  ...
  templateUrl: './lecture-programs.component.html',
  styleUrls: ['./lecture-programs.component.scss']
})
export class LectureProgramsComponent  extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'select',
...
generatePdf() {
  const doc = new jsPDF();
  const headers = [['Program Name', 'Class', 'Start Date','End Date','Duration','Time','Status']];
