...
@Component({
  selector: 'app-program-exam-schedule',
  templateUrl: './program-exam-schedule.component.html',
  styleUrls: ['./program-exam-schedule.component.scss']
})
export class ProgramExamScheduleComponent extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'program Name',
    ...
    map(() => {
      ...
      this.filteredData = this.exampleDatabase.data
        ...
        .filter((examSchedule: ExamSchedule) => {
          const searchStr = (
            examSchedule.ProgramName +
            examSchedule.programCode 
            // examSchedule.date +
            // examSchedule.time +
