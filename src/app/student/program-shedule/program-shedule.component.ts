...
@Component({
  selector: 'app-program-shedule',
  templateUrl: './program-shedule.component.html',
  styleUrls: ['./program-shedule.component.scss']
})
export class ProgramSheduleComponent extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'program Name',
